...
//			}
			...
			if(qryvo.getSelfOrgs()!=null &&qryvo.getOppOrgs()!=null){
				...
				if(map != null ){
					...
					resetQryVOResult(measrepvo, measVO, provo, qryvo, handOffset, pk_otherDynKey);
	 ...
	 */
	private void resetQryVOResult(MeasureReportVO measrepvo, MeasureVO measVO, ProjectVO provo, ContrastQryVO qryvo, Map<String, String> handOffset, String pk_otherDynKey)
			throws BusinessException {
		...
		if(null != subkeys  && null != handOffset){
			...
			otherDynKeyval = handOffset.get(pk_otherDynKey);
		}
