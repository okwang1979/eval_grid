...
//                    new int[]{IFuncType.PARAM_REF_TYPE_ACCOUNT,IFuncType.PARAM_COMBOX_TYPE_DATASOURCE,IFuncType.PARAM_REF_TYPE_NOREF}
     	    ...
     	    new UfoFuncInfo(
     	    		UCHECK,
     	    		DXFUNC,
     	    		new String[]{/*UfoFuncList.PARANAMES[UfoFuncList.HBACCOUNT]*/"'"+nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003069")/*@res "科目名称"*/+"/"+nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003072")/*@res "科目编码"*/+"'",UfoFuncList.PARANAMES[UfoFuncList.DATASOURCE]},
