...
public class JNFileUserGroupForMtapp  implements IParticipantFilter {
	...
	public HashSet<String> filterUsers(ParticipantFilterContext pfc)
		...
		String pk_billorg = (String) billvo.getParentVO().getAttributeValue(MatterAppVO.APPLY_ORG);
		String pk_dept = (String) billvo.getParentVO().getAttributeValue(MatterAppVO.ASSUME_DEPT);//assume_dept
