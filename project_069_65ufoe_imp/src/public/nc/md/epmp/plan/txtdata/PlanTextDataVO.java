package nc.md.epmp.plan.txtdata;

 
import nc.vo.pub.SuperVO;

public class PlanTextDataVO extends SuperVO{
	
	private String pk_obj;
	
	private String pk_taskdef;
 
	private String pk_task ;
	private String pk_sheet ;
	...
	public String getPk_obj() {
		return pk_obj;
	}

	public void setPk_obj(String pk_obj) {
		this.pk_obj = pk_obj;
	}
	
	

	public String getPk_taskdef() {
		return pk_taskdef;
	}

	public void setPk_taskdef(String pk_taskdef) {
		this.pk_taskdef = pk_taskdef;
	}
	...
	public String getPk_sheet() {
		return pk_sheet;
	}

	public void setPk_sheet(String pk_sheet) {
		this.pk_sheet = pk_sheet;
	}
