...
public nc.ui.pubapp.uif2app.view.BillOrgPanel getOrgPanel(){
 ...
 return (nc.ui.pubapp.uif2app.view.BillOrgPanel)context.get("orgPanel");
  ...
  bean.setModel(getManageAppModel());
  bean.setOrgGetter(getCMPOrgGetter_c5a370());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.cmp.view.CMPOrgGetter getCMPOrgGetter_c5a370(){
 if(context.get("nc.ui.cmp.view.CMPOrgGetter#c5a370")!=null)
 return (nc.ui.cmp.view.CMPOrgGetter)context.get("nc.ui.cmp.view.CMPOrgGetter#c5a370");
  nc.ui.cmp.view.CMPOrgGetter bean = new nc.ui.cmp.view.CMPOrgGetter();
  context.put("nc.ui.cmp.view.CMPOrgGetter#c5a370",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getUserdefQueryParam_16d1189());  list.add(getUserdefQueryParam_19a4669());  return list;}

private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_16d1189(){
 if(context.get("nc.ui.uif2.editor.UserdefQueryParam#16d1189")!=null)
 return (nc.ui.uif2.editor.UserdefQueryParam)context.get("nc.ui.uif2.editor.UserdefQueryParam#16d1189");
  nc.ui.uif2.editor.UserdefQueryParam bean = new nc.ui.uif2.editor.UserdefQueryParam();
  context.put("nc.ui.uif2.editor.UserdefQueryParam#16d1189",bean);
...
private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_19a4669(){
 if(context.get("nc.ui.uif2.editor.UserdefQueryParam#19a4669")!=null)
 return (nc.ui.uif2.editor.UserdefQueryParam)context.get("nc.ui.uif2.editor.UserdefQueryParam#19a4669");
  nc.ui.uif2.editor.UserdefQueryParam bean = new nc.ui.uif2.editor.UserdefQueryParam();
  context.put("nc.ui.uif2.editor.UserdefQueryParam#19a4669",bean);
...
private List getManagedList3(){  List list = new ArrayList();  list.add(getUserdefQueryParam_184bc38());  list.add(getUserdefQueryParam_161328c());  return list;}

private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_184bc38(){
 if(context.get("nc.ui.uif2.editor.UserdefQueryParam#184bc38")!=null)
 return (nc.ui.uif2.editor.UserdefQueryParam)context.get("nc.ui.uif2.editor.UserdefQueryParam#184bc38");
  nc.ui.uif2.editor.UserdefQueryParam bean = new nc.ui.uif2.editor.UserdefQueryParam();
  context.put("nc.ui.uif2.editor.UserdefQueryParam#184bc38",bean);
  bean.setMdfullname("cmp.cmp_settlement");
  bean.setPos(0);
  bean.setPrefix("def");
setBeanFacotryIfBeanFacatoryAware(bean);
...
private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_161328c(){
 if(context.get("nc.ui.uif2.editor.UserdefQueryParam#161328c")!=null)
 return (nc.ui.uif2.editor.UserdefQueryParam)context.get("nc.ui.uif2.editor.UserdefQueryParam#161328c");
  nc.ui.uif2.editor.UserdefQueryParam bean = new nc.ui.uif2.editor.UserdefQueryParam();
  context.put("nc.ui.uif2.editor.UserdefQueryParam#161328c",bean);
  bean.setMdfullname("cmp.cmp_detail");
  bean.setPos(1);
  bean.setPrefix("def");
setBeanFacotryIfBeanFacatoryAware(bean);
...
private List getManagedList4(){  List list = new ArrayList();  list.add(getQueryParam_3daf11());  list.add(getQueryParam_1b0a817());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_3daf11(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#3daf11")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#3daf11");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#3daf11",bean);
  bean.setMdfullname("cmp.cmp_settlement");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1b0a817(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1b0a817")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1b0a817");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1b0a817",bean);
  bean.setMdfullname("cmp.cmp_detail");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.tmpub.filter.DefaultRefWherePartHandler getDefaultRefWherePartHandler(){
 ...
 return (nc.ui.tmpub.filter.DefaultRefWherePartHandler)context.get("defaultRefWherePartHandler");
  ...
  bean.setUiAccessor(getSettleUIAccessor_eb9570());
...
private nc.ui.cmp.settlement.filter.SettleUIAccessor getSettleUIAccessor_eb9570(){
 if(context.get("nc.ui.cmp.settlement.filter.SettleUIAccessor#eb9570")!=null)
 return (nc.ui.cmp.settlement.filter.SettleUIAccessor)context.get("nc.ui.cmp.settlement.filter.SettleUIAccessor#eb9570");
  nc.ui.cmp.settlement.filter.SettleUIAccessor bean = new nc.ui.cmp.settlement.filter.SettleUIAccessor();
  context.put("nc.ui.cmp.settlement.filter.SettleUIAccessor#eb9570",bean);
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_ce6d42());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_ce6d42(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#ce6d42")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#ce6d42");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#ce6d42",bean);
...
private List getManagedList14(){  List list = new ArrayList();  list.add(getHSNode_e3d92c());  list.add(getVSNode_1ba4805());  return list;}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_e3d92c(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#e3d92c")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#e3d92c");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#e3d92c",bean);
  bean.setName(getI18nFB_a0010d());
  bean.setDividerLocation(0.2f);
  bean.setLeft(getCNode_a4fdd3());
  bean.setRight(getVSNode_1b1ff1d());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private java.lang.String getI18nFB_a0010d(){
 if(context.get("nc.ui.uif2.I18nFB#a0010d")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#a0010d");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#a0010d",bean);  bean.setResDir("3607mng_0");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#a0010d",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_a4fdd3(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#a4fdd3")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#a4fdd3");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#a4fdd3",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1b1ff1d(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#1b1ff1d")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#1b1ff1d");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#1b1ff1d",bean);
  bean.setUp(getCNode_145415());
  bean.setDown(getCNode_9c651b());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_145415(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#145415")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#145415");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#145415",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_9c651b(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#9c651b")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#9c651b");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#9c651b",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1ba4805(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#1ba4805")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#1ba4805");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#1ba4805",bean);
  bean.setName(getI18nFB_c7085f());
  bean.setUp(getCNode_f6b632());
  bean.setDown(getTBNode_17ae69c());
  bean.setDividerLocation(30f);
...
private java.lang.String getI18nFB_c7085f(){
 if(context.get("nc.ui.uif2.I18nFB#c7085f")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#c7085f");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#c7085f",bean);  bean.setResDir("3607mng_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#c7085f",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_f6b632(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#f6b632")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#f6b632");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#f6b632",bean);
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_17ae69c(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#17ae69c")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#17ae69c");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#17ae69c",bean);
  bean.setName(getI18nFB_133b311());
...
private java.lang.String getI18nFB_133b311(){
 if(context.get("nc.ui.uif2.I18nFB#133b311")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#133b311");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#133b311",bean);  bean.setResDir("3607mng_0");
  bean.setDefaultValue("卡片");
  bean.setResId("03607mng-0399");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#133b311",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList15(){  List list = new ArrayList();  list.add(getCNode_1eca2fb());  list.add(getCNode_1087219());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_1eca2fb(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1eca2fb")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1eca2fb");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1eca2fb",bean);
  bean.setComponent(getBillFormEditor());
  bean.setName(getI18nFB_13126d5());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private java.lang.String getI18nFB_13126d5(){
 if(context.get("nc.ui.uif2.I18nFB#13126d5")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#13126d5");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#13126d5",bean);  bean.setResDir("3607mng_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#13126d5",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_1087219(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1087219")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1087219");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1087219",bean);
  bean.setComponent(getOppui());
  bean.setName(getI18nFB_c00ec0());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private java.lang.String getI18nFB_c00ec0(){
 if(context.get("nc.ui.uif2.I18nFB#c00ec0")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#c00ec0");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#c00ec0",bean);  bean.setResDir("3607mng_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#c00ec0",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_670b8b(){
 if(context.get("nc.ui.uif2.I18nFB#670b8b")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#670b8b");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#670b8b",bean);  bean.setResDir("3607mng_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#670b8b",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getBillSignActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("billSignActionGroup");
  ...
  bean.setName(getI18nFB_127010b());
...
private java.lang.String getI18nFB_127010b(){
 if(context.get("nc.ui.uif2.I18nFB#127010b")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#127010b");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#127010b",bean);  bean.setResDir("3607set_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#127010b",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getBillSettleActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("billSettleActionGroup");
  ...
  bean.setName(getI18nFB_1b58b34());
...
private java.lang.String getI18nFB_1b58b34(){
 if(context.get("nc.ui.uif2.I18nFB#1b58b34")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1b58b34");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1b58b34",bean);  bean.setResDir("3607set_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1b58b34",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getCardBillSettleActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("cardBillSettleActionGroup");
  ...
  bean.setName(getI18nFB_1c62ee2());
...
private java.lang.String getI18nFB_1c62ee2(){
 if(context.get("nc.ui.uif2.I18nFB#1c62ee2")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1c62ee2");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1c62ee2",bean);  bean.setResDir("3607set_0");
  bean.setDefaultValue("结算");
  bean.setResId("03607set-0070");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1c62ee2",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_2ff856(){
 if(context.get("nc.ui.uif2.I18nFB#2ff856")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#2ff856");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#2ff856",bean);  bean.setResDir("3607set_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#2ff856",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getBillAssistantActionGroup(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billAssistantActionGroup");
  ...
  bean.setCode("billAssistant");
  bean.setName(getI18nFB_15914c5());
...
private java.lang.String getI18nFB_15914c5(){
 if(context.get("nc.ui.uif2.I18nFB#15914c5")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#15914c5");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#15914c5",bean);  bean.setResDir("3607mng_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#15914c5",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList22(){  List list = new ArrayList();  list.add(getDocManageAction());  return list;}
...
public nc.funcnode.ui.action.MenuAction getPayActionGroup(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("payActionGroup");
  ...
  bean.setName(getI18nFB_162c477());
...
private java.lang.String getI18nFB_162c477(){
 if(context.get("nc.ui.uif2.I18nFB#162c477")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#162c477");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#162c477",bean);  bean.setResDir("3607set_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#162c477",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getEuropActionGroup(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("europActionGroup");
  ...
  bean.setName(getI18nFB_15098bb());
...
private java.lang.String getI18nFB_15098bb(){
 if(context.get("nc.ui.uif2.I18nFB#15098bb")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#15098bb");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#15098bb",bean);  bean.setResDir("3607set_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#15098bb",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_5b5615(){
 if(context.get("nc.ui.uif2.I18nFB#5b5615")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#5b5615");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#5b5615",bean);  bean.setResDir("3607set_0");
  bean.setDefaultValue("欧盟支付");
  bean.setResId("03607set-0917");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#5b5615",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_708723(){
 if(context.get("nc.ui.uif2.I18nFB#708723")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#708723");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#708723",bean);  bean.setResDir("3607set_0");
  bean.setDefaultValue("支付");
  bean.setResId("03607set-0072");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#708723",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getLinkQueryActionGroup(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("linkQueryActionGroup");
  ...
  bean.setName(getI18nFB_1b8489b());
...
private java.lang.String getI18nFB_1b8489b(){
 if(context.get("nc.ui.uif2.I18nFB#1b8489b")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1b8489b");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1b8489b",bean);  bean.setResDir("3607set_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1b8489b",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.pubapp.uif2app.view.EditHandleMediator getCardPanelCurrEditDigitMediator(){
 ...
 return (nc.ui.pubapp.uif2app.view.EditHandleMediator)context.get("cardPanelCurrEditDigitMediator");
  ...
  bean.setDispatcher(getMany2ManyDispatcher_1a6ca6f());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pubapp.uif2app.view.eventdispatch.Many2ManyDispatcher getMany2ManyDispatcher_1a6ca6f(){
 if(context.get("nc.ui.pubapp.uif2app.view.eventdispatch.Many2ManyDispatcher#1a6ca6f")!=null)
 return (nc.ui.pubapp.uif2app.view.eventdispatch.Many2ManyDispatcher)context.get("nc.ui.pubapp.uif2app.view.eventdispatch.Many2ManyDispatcher#1a6ca6f");
  ...
  context.put("nc.ui.pubapp.uif2app.view.eventdispatch.Many2ManyDispatcher#1a6ca6f",bean);
