		...
		public String appAccTabWherePart(String[] pk_selfaccountingbooks,
			...
			for (int i = 0; i < pk_selfaccountingbooks.length; i++) {
				for (int j = 0; j < pk_otheraccountingbooks.length; j++) {
					...
					String pk_otheraccountingbook = pk_otheraccountingbooks[j];
					// String[]
					// pk_accasoas=nc.vo.gl.contrast.rule.ContrastRuleSubjUtil.getAccasoas(contrastrulevo,
					// (bSelf? pk_selfaccountingbook : pk_otheraccountingbook),
					// qryvo.getYear(), qryvo.getPeriod(), (bSelf ?
					// qryvo.getRuledirection() : !qryvo.getRuledirection()));
					// if(null==pk_accasoas || pk_accasoas.length==0){
					// return null;
					// }
					if (bFirst) {
						bFirst = false;
					...
					content.append("  ( ");
//					if (false/* pk_accasoas.length==1 */) {
//						// content.append("
//						// cdata.pk_accasoa='"+pk_accasoas[0]+"'
//						// and cdata.pk_accountingbook='"+ pk_selfaccountingbook
//						// +
//						// "' and CDATA.PK_OTHERORGBOOK='" +
//						// pk_otheraccountingbook
//						// + "'" );
//
//					} else if (false/* pk_accasoas.length<500 */) {
//						// content.append(" cdata.pk_accasoa in (
//						// "+nc.vo.gl.glreport.publictool.GlTools.getValuesFromStrArrayForSql(pk_accasoas)+")
//						// and cdata.pk_accountingbook='"+ pk_selfaccountingbook
//						// +
//						// "' and CDATA.PK_OTHERORGBOOK='" +
//						// pk_otheraccountingbook
