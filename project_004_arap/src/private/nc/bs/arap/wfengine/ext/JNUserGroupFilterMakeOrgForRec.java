package nc.bs.arap.wfengine.ext;
...
public class JNUserGroupFilterMakeOrgForRec implements IParticipantFilter {
	...
	public HashSet<String> filterUsers(ParticipantFilterContext pfc)
		...
		String pk_billorg = (String) billvo.getParentVO().getAttributeValue("pk_org");
		String pk_dept = (String) billvo.getParentVO().getAttributeValue("pk_deptid");//assume_dept
